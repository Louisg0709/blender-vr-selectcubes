...
# 13th February 2021
# This is Louis Griffiths development version to prototype a controller
#  TODO update classes in class list
#  TODO run through turorial at https://docs.blender.org/manual/en/latest/advanced/scripting/addon_tutorial.html
#       and build simple test cubes function
#  Tested interface worked individually but overlap of name spaces for the classes! So when other switched on some controls lost from handler
...
bl_info = {
    ...
    "author": "Julian Eisel (Severin), Sebastian Koenig, Louis Griffiths",
    "version": (0, 0, 1),
    "blender": (2, 90, 0),
    "location": "3D View > Sidebar > VR",
    "description": ("View the viewport with virtual reality glasses and detect motions to implement simple cotrollers"
                    "(head-mounted displays)"),
    "support": "OFFICIAL",
    "warning": "This is an early, limited preview of in development "
               "VR support for Blender. Including simple control handlers",
...
class VIEW3D_PT_vr_cont_session_view(Panel):
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = "VRCON"
    bl_label = "View Controller"
...
class VIEW3D_PT_vr_cont_session(Panel):
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = "VRCON"
    bl_label = "VR Test Controller Session"
    ...
    def draw(self, context):
        ...
        # have commit rights...
        toggle_info = (
            ("Start VR Controller Session", 'PLAY') if not is_session_running else (
                "Stop VR Controller Session", 'SNAP_FACE')
        )
...
class VIEW3D_PT_vr_cont_info(bpy.types.Panel):
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = "VRCON"
    bl_label = "VR Con. Info"
...
#Don't forget to add Logs new classes here
#TODO template for new close
classes = (
    VIEW3D_PT_vr_cont_session,
    VIEW3D_PT_vr_cont_session_view,
...
def register():
    if not bpy.app.build_options.xr_openxr:
        bpy.utils.register_class(VIEW3D_PT_vr_cont_info)
        return
